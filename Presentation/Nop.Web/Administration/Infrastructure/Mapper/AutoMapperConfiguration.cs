    ...
    public static class AutoMapperConfiguration
    {
        ...
        public static void Init()
        {
            _mapperConfiguration = new MapperConfiguration(cfg =>
            {
                ...
                //topic template
                cfg.CreateMap<SKL_Cader, SKL_CaderModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<SKL_CaderModel, SKL_Cader>();
                cfg.CreateMap<SKL_ColorCode, SKL_ColorCodeModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<SKL_ColorCodeModel, SKL_ColorCode>();
