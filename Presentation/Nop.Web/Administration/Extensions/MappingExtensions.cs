...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static SKL_ColorCodeModel ToModel(this SKL_ColorCode entity)
        {
            return entity.MapTo<SKL_ColorCode, SKL_ColorCodeModel>();
        }
        ...
        public static SKL_Cader ToEntity(this SKL_CaderModel model)
        {
            return model.MapTo<SKL_CaderModel, SKL_Cader>();
        }
